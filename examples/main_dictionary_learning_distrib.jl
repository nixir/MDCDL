...
using ImageFiltering.Algorithm: FIR, FFT
...
@show haveresource(CPUThreads)
# options for sparse coding
sc_options = ( iterations = 1000, sparsity = 0.5, filter_domain=:convolution, resource=CPUThreads(FIR()),)
# options for dictionary update
du_options = ( iterations = 100, stepsize = 1e-3,)

# general options of dictionary learning
options = ( epochs  = 100,
            verbose = :none, # :none, :standard, :specified, :loquacious
